...
public class PostDataScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_data_screen);
        ...
        postDataBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameEdt.getText().toString().isEmpty() && jobEdt.getText().toString().isEmpty()) {
                    Toast.makeText(PostDataScreen.this, "Please enter both the values", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void postData(String name, String job) {
        ...
        call.enqueue(new Callback<DataModal>() {
            ...
            public void onResponse(Call<DataModal> call, Response<DataModal> response) {
                ...
                Toast.makeText(PostDataScreen.this, "Data added to API", Toast.LENGTH_SHORT).show();
